   ...
   reloadCertification: async () =>{
        ...
        try{
          ...
          if(certificationInfo[6]!=0){
            ...
            $('#caseBoxUniqueAddr').text(certificationInfo[6]);
          }else{
    ...
    loadBoxes: async (index, certificateInstance) =>{
      ...
      $('#uniqueId'+index+'').text(BoxesInfo[1]);
      var certLink=window.location.origin+"/bcsifi_serial_rop/?UniqueIdentifier="+BoxesInfo[1];
